...
exports.create = (req, res) => {
  ...
  form.parse(req, (err, fields, files) => {
    ...
    const { title, body, categories, tags, tribes, caption } = fields;
    ...
    let arrayOfTribes = tribes && tribes.split(",");
...
exports.listAllBlogsCategoriesTags = (req, res) => {
  ...
  Blog.find({})
    ...
    .limit(limit)
    .select(
      "_id title slug excerpt categories tags tribes postedBy createdAt updatedAt"
    )
    .exec((err, data) => {
      if (err) {
        return res.json({
      ...
      Category.find({}).exec((err, c) => {
        ...
        Tag.find({}).exec((err, t) => {
          ...
          Tribe.find({}).exec((err, tr) => {
            ...
            res.json({ blogs, categories, tribes, tags, size: blogs.length });
          });
